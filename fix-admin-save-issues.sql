-- Fix Admin Save Issues - Complete Database Setup
-- This script addresses all the issues preventing admin from saving content

-- Enable necessary extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- ========================================
-- 1. FIX PROFILES TABLE AND ADMIN SETUP
-- ========================================

-- Create profiles table if not exists (with existing structure)
