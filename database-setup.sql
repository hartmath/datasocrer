...
ALTER TABLE IF EXISTS lead_import_configs ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS imported_leads ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS saved_payment_methods ENABLE ROW LEVEL SECURITY;
...
-- Create lead_import_configs table if not exists
...
-- Create imported_leads table if not exists
